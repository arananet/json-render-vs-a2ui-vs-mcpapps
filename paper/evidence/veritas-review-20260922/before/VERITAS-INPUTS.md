...
- `REPRODUCTION.md` supplies command semantics and limitations. The long
  historical `EXECUTION.md` remains local but is not sent redundantly with the
  selected dated logs.
...
## Listing-only verification on 22 September 2026
...
**Remaining limitation:** the CLI flags inputs longer than 24,000 characters
